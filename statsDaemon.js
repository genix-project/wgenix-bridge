...
(async function main() {
  ...
  const refresh = async function () { 
    // Get genix stats.
    genixStats = await genix.getTxOutSetInfo();
    ...
    const coinPaprikaTicker = await coinPaprikaClient.getTicker({ coinId: "genix-genix" });
    ...
    const cap = price * genixStats.total_amount;
